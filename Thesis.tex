...
The \CTC algorithm performs variably on different corpora, and research have suggested that better algorithm designs are needed. The shortcomings of manually tuning the algorithm design for each corpus necessitate some form of automatic optimisation of the \CTC algorithm's design. This thesis proposes a genetic algorithm that automatically produces optimised algorithm designs for the \CTC algorithm, and demonstrates the feasibility of the optimisation algorithm in terms of effectiveness, computing time, equipment requirements, and knowledge.
}
...
Thanks for the lunches, coffee breaks, and all the friendly talks. Without them I would surely not have finished.
