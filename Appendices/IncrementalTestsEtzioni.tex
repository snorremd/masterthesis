...
\begin{tikzpicture}
  ...
  \addplot+ [style={bblue,mark size=1.5}] table [col sep=semicolon,y=Recall 0,x=n-slice] {Diagrams/Etzioni/testNSlices.csv};
  \addplot+ [style={ggreen,mark=triangle*,mark size=1.5}] table [col sep=semicolon,y=F-Measure 0,x=n-slice] {Diagrams/Etzioni/testNSlices.csv};
